...
//        tempTree.levelOrder();
        ...
        com.practice.oldIntel.practice.practice4.Tree treeNR = new com.practice.oldIntel.practice.practice4.Tree();
        treeNR.root = new com.practice.oldIntel.practice.practice4.Tree.Node(10);
        treeNR.root.left = new com.practice.oldIntel.practice.practice4.Tree.Node(8);
        treeNR.root.right = new com.practice.oldIntel.practice.practice4.Tree.Node(2);
        treeNR.root.left.left = new com.practice.oldIntel.practice.practice4.Tree.Node(3);
        treeNR.root.right.right = new com.practice.oldIntel.practice.practice4.Tree.Node(90);
...
//        }
    ...
    //Redo
    static void connectNextRight(com.practice.oldIntel.practice.practice4.Tree.Node root) {
        if (root == null) return;
        if (root.right != null) {
            if (root.left != null) {
    ...
    private static com.practice.oldIntel.practice.practice4.Tree.Node getNextRight(
            com.practice.oldIntel.practice.practice4.Tree.Node root) {
        com.practice.oldIntel.practice.practice4.Tree.Node temp = root.nextRight;
        while (temp != null) {
    ...
    static void printAllConnectedRight(com.practice.oldIntel.practice.practice4.Tree.Node root) {
        if (root == null) return;
